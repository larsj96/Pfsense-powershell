...
#>
    ...
    process {
        ...
        write-verbose $jsonpayload
        invoke-restmethod "$($pfsenseconnection.server)api/v1/interface/"  -Headers $pfsenseconnection.headers -body $jsonpayload -method "PUT" -Verbose
...
function Get-PfsenseInterface {
    ...
    process {
        $data = invoke-restmethod "$($pfsenseconnection.server)api/v1/interface"  -Headers $pfsenseconnection.headers -method "GET"
...
function Remove-PfsenseInterface {
    <#
.PARAMETER if
Specify the physical interface to configure
...
#>
    ...
    process {
        ...
        write-verbose $jsonpayload
        invoke-restmethod "$($pfsenseconnection.server)api/v1/interface/"  -Headers $pfsenseconnection.headers -body $jsonpayload -method "DELETE"
    }
}