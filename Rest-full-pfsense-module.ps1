...
#>
    ...
    process {
        ...
        invoke-restmethod "https://192.168.2.1/api/v1/interface/"  -Headers $Headers -body $jsonpayload -method "POST"



    }
}
function Add-pfsenseinterfacevlan {
    <#
...
#>
    ...
    process {
        ...
        write-verbose $jsonpayload
        invoke-restmethod "https://192.168.2.1/api/v1/interface/vlan"  -Headers $Headers -body $jsonpayload -method "POST"
...
function get-pfsenseinterfacevlan {
    ...
    $data = invoke-restmethod "https://192.168.2.1/api/v1/interface/vlan"  -Headers $Headers  -method "get"
    $data.data
...
Set a description for the new VLAN interface
    ...
    process {
        ...
        write-verbose $jsonpayload
        invoke-restmethod "https://192.168.2.1/api/v1/interface/vlan"  -Headers $Headers -body $jsonpayload -method "PUT"
...
#>
    ...
    process {
        ...
        write-verbose $jsonpayload
        invoke-restmethod "https://192.168.2.1/api/v1/interface/"  -Headers $Headers -body $jsonpayload -method "PUT"
...
git remote add origin https://github.com/larsj96/Pfsense-powershell.git
